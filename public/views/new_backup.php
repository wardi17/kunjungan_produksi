        ...
        <div class="row col-md-12-col-12">
          <div class= "col-md-6">
                   <div class =" row col-md-12 mb-3">
                      ...
                      <div class="row col-md-12 mb-3">
                                ...
                                <div class="col-sm-3">
                                <input type="text"  class="form-control" name ="id_kunjungan" id="id_kunjungan" value="" required>
                                </div>
                        </div>
                        <div class="row col-md-12 mb-3">
          ...
          <div class= "col-md-6">
                        ...
                        <div class="row col-md-12">
                            ...
                            <div class="col-md-2">
                            <button type="button"id="sendEmail" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#SendemailModal">
                              Pilih
                            </button>
                      ...
                      <div class="row col-md-12">
                            ...
                            <div class=" col-md-12 row mb-3">
                              <div class="col-md-3">
                                  <div class="col-md-8 row">
                                    ...
                                    <img id="tokoImage1" src="assets/images/image1.jpg" class="box md-3" alt="1"> 
                              ...
                              <div class="col-md-8 row">
                                ...
                                <img id="tokoImage2" src="assets/images/image2.jpg" class="box" alt="2">    
                              ...
                              <div class="col-md-8 row">
                                ...
                                <img id="tokoImage3" src="assets/images/image3.jpg" class="box" alt="3"> 
                              ...
                              <div class="col-md-8 row">
                                ...
                                <img id="tokoImage4" src="assets/images/image4.jpg" class="box" alt="4">
                        ...
                        <div class="row col-md-12 mb-3">  
                                ...
                                <div class="col-sm-8">
                                  <textarea  style="height:100px;" type="text" class="form-control"  name="ket" id="ket" value="" required> </textarea>
                                </div>
                        </div>
          </div>
...
$("#delete_image1").on("click",function(){
    ...
    let newUrl ='assets/images/image1.jpg';
...
$("#delete_image2").on("click",function(){
    ...
    let newUrl ='assets/images/image2.jpg';
...
$("#delete_image3").on("click",function(){
    ...
    let newUrl ='assets/images/image3.jpg';
...
$("#delete_image4").on("click",function(){
    ...
    let newUrl ='assets/images/image4.jpg';
