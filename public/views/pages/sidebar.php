...
$sql=odbc_exec($conn,$query);
 ...
 $kode_log = (isset($_SESSION['kode_log']))? $_SESSION['kode_log'] : '';
...
<div id="app">
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <li
                class="sidebar-item   <?php if ($page == 'kunjungan') {echo 'active';} else {echo'';} ?> " aria-current="page">
                <a href="index.php?page=kunjungan" class='sidebar-link'>
                    <i class="bi bi-cloud-arrow-up-fill"></i>
                    <span>Jenis Kunjungan</span>
                </a>
            </li>
            <li class="sidebar-title">Kunjungan</li>
            ...
            <li
                class="sidebar-item   <?php if ($page == 'solusi') {echo 'active';} else {echo'';} ?> " aria-current="page">
                <a href="index.php?page=solusi" class='sidebar-link'>
                    <i class="bi bi-cloud-arrow-up-fill"></i>
                    <span>List Kunjungan</span>
                </a>
            </li>
            <!-- <li
                class="sidebar-item   <?php if ($page == 'send_email') {echo 'active';} else {echo'';} ?> " aria-current="page">
                <a href="index.php?page=send_email" class='sidebar-link'>
                    <i class="bi bi-cloud-arrow-up-fill"></i>
            ...
            <li
                class="sidebar-item  <?php if($page =='rpt_solusi'){echo 'active';} else {echo'';} ?>">
                <a href="index.php?page=rpt_solusi" class='sidebar-link'>
