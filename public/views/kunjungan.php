      ...
      <div class="modal-content">
        ...
        <form  id ="formtambah"  class ="form form-horizontal">
                    ...
                    <div class="row col-md-12 mb-3">  
                                <label for="kode_kjn" class="col-sm-4 col-form-label">Kode Kunjungan</label>
                                <div class="col-sm-3">
                                  <input type="text" class="form-control"  name="kode_kjn" id="kode_kjn" value="" required>
                                </div>
                        </div>
                        <div class="row col-md-12">  
                                <label for="nama_kjn" class="col-sm-4 col-form-label">Jenis Kunjungan</label>
                                <div class="col-sm-6">
      ...
      <div class="modal-header">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                ...
                <div class="modal-body">
                  <form id="formdelete">
                  <div class="row col-md-12 mb-3">  
                              <label for="kode_delete" class="col-sm-4 col-form-label">Kode Kunjungan</label>
                              <div class="col-sm-3">
                                <input disabled type="text" class="form-control"  name="kode_delete" id="kode_delete" value="" required>
                              </div>
                      </div>
                      <div class="row col-md-12 mb-3">  
                              <label for="kjn_delete" class="col-sm-4 col-form-label">Jenis Kunjungan</label>
                              <div class="col-sm-6">
    ...
    <div class="modal-header">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                ...
                <form  id ="formedit"  class ="form form-horizontal">
                  <div class="row col-md-12 mb-3">  
                              <label for="kode_edit" class="col-sm-4 col-form-label">Kode Kunjungan</label>
                              <div class="col-sm-3">
                                <input disabled type="text" class="form-control"  name="kode_edit" id="kode_edit" value="" required>
                              </div>
                      </div>
                      <div class="row col-md-12">  
                              <label for="nama_edit" class="col-sm-4 col-form-label">Jenis Kunjungan</label>
                              <div class="col-sm-6">
...
//tambah data
  $("#Createdata").on('click',function(e){
    ...
    $.ajax({
      url:'models/master_kunjungan/tambahdata.php',
      method:'POST',
  ...
  //end tambah data
    ...
    $("#delete").on("click",function(e){
        ...
        $.ajax({
            url:"models/master_kunjungan/delete_data.php",
            type:"POST",
            data:{kode:kode},
                dataType:'json',                  
            success: function(result){ 
...
$("#close").on("click",function(e){
  ...
  $("#formedit").trigger("reset");
    ...
    $("#Editdata").on("click",function(e){
        ...
        $.ajax({
            url:'models/master_kunjungan/edit_data.php',
            type:'POST',
            dataType:'json',
            data :{kode:kode,nama:nama},
...
function get_header(){
    ...
    <h4 class="text-center">Master Jenis Kunjungan </h4>
    </div></div>
        ...
        <section class="section">
                <div class="card">
                    ...
                    <table id="tabel1" class='display table-info' style='width:100%'>                    
                                    ...
                                    <tr>
                                                <th style="width:2%">Kode Kunjungan</th>
                                                <th style="width:2%">Jenis Kunjungan</th>
                                                <th style="width:1%">
